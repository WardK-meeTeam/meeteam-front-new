    ...
    <ProfileCard title="기본 정보">
      ...
      <div className="mt-4 space-y-4">
        <a
          ...
          className="flex items-center gap-3 border-y border-icon-gray py-4 text-sm leading-5 font-medium text-text-body transition-colors hover:text-text-black"
        >
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-icon-gray text-text-gray">
