  ...
  if (editable) {
    ...
    return (
      <section className="space-y-4">
        ...
        <div className="rounded-2xl border border-mt-border bg-mt-white">
          <BaseTextarea
            rows={8}
            textareaSize="L"
            maxLength={500}
            ...
            className="min-h-56 resize-none rounded-b-none border-0 px-5 py-5 text-base leading-7 focus:ring-0"
          />
