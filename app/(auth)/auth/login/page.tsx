...
export default function Page() {
  return (
    <section className="space-y-6 md:space-y-8 bg-white p-10 max-w-md rounded-3xl flex flex-col items-center gap-8 shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)]">
